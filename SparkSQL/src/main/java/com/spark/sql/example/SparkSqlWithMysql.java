...
public class SparkSqlWithMysql {
	...
	private static void printDataFrameScheme(DataFrame df) {
		df.show();
		/*
		 * StructType tableType = df.schema(); StructField[] columnType =
		 * tableType.fields(); Map<String, String> columnElement = new
		 * HashMap<String, String>(); for (StructField element : columnType) {
		 * 
